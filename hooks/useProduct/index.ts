...
const fetchProduct = async (slug: string): Promise<IProduct> => {
  ...
  const productUrl = `${spreeUrl}/api/v2/storefront/products/${slug}?include=default_variant,variants,option_types,product_properties,taxons,images,variants.option_values,variants.images&image_transformation[size]=2400x&image_transformation[quality]=90`;
